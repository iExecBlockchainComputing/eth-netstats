...
History.prototype.add = function(block, id, trusted, addingHistory)
{
	...
	{
		console.log("In add History => ",block.number, id, addingHistory);
		...
		{
			console.log("Couldn't find block with this height");
			// Couldn't find block with this height

			// Getting previous max block
			var prevBlock = this.prevMaxBlock(block.number);
			// console.log("prev Block getting prev block =>",prevBlock.block.number);
			...
			// console.log("===========this.bestBlockNumber() ========",this.bestBlockNumber());
			// console.log("===========MAX_HISTORY ========",MAX_HISTORY);
			// console.log("===========this._items.length === 0 ========",this._items.length === 0);
			// console.log("===========this._items.length === MAX_HISTORY && block.number > this.worstBlockNumber()============",this._items.length === MAX_HISTORY && block.number > this.worstBlockNumber());
			// console.log("======================this._items.length === MAX_HISTORY===========================================",this._items.length === MAX_HISTORY);
			// console.log("======================block.number > this.worstBlockNumber()=======================================",block.number > this.worstBlockNumber());
			// console.log("===========this._items.length < MAX_HISTORY && block.number < this.bestBlockNumber() && addingHistory=======",this._items.length < MAX_HISTORY && block.number < this.bestBlockNumber() && addingHistory);
			// console.log("======================this._items.length < MAX_HISTORY=============================================",this._items.length < MAX_HISTORY);
			// console.log("======================block.number < this.bestBlockNumber()========================================",block.number < this.bestBlockNumber());
			// console.log("======================addingHistory================================================================", addingHistory);
...
History.prototype.getCharts = function()
{
	...
	{
		// console.log("this._items 2 =>",this._items);
		var chartHistory = _( this._items ) // pb ici
			...
			{
				console.log("===========INFO===========");
				console.log(item.height ,"\n",item.block.time / 1000,"\n",
				item.block.difficulty,"\n",item.block.uncles.length,"\n",
				item.block.transactions.length,"\n",item.block.gasUsed,"\n",
				item.block.gasLimit,"\n",item.block.miner);
				return {
					height: item.height,
